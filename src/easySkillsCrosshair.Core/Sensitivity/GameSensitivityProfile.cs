...
/// <param name="IsProOnly">Part of the extended game library unlocked by Pro.</param>
/// <param name="IsVerified">Cross-checked against an external reference converter.</param>
public sealed record GameSensitivityProfile(
    string Id,
    string Name,
    double Yaw,
    int Decimals,
